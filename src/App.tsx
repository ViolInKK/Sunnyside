  ...
  return (
    <div className='App'>
      ...
      <div className='header-container'>
        ...
        <svg className='arrow' width="36" height="114" xmlns="http://www.w3.org/2000/svg"><g stroke="#FFF" stroke-width="7" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"><path d="M18 3v100M3 95.484l15 15 15-15"/></g></svg>
      </div>
        ...
        <div className='top-grid-item'>
          <div>
            ...
            <div id='yellow'>
              ...
              <div className='under-line' id='yellow'></div>
            </div>
          </div>
        </div>
        <div className='top-grid-item' id='egg'></div>
        <div className='top-grid-item' id='ice-cream'></div>
        <div className='top-grid-item'>
          <div>
            ...
            <div id='red'>
              <button>LEARN MORE</button>
              <div className='under-line' id='red'></div>
            </div>
          </div>
        </div>
        <div className='top-grid-item' id='cherry'>
          <div>
            <h2>Graphic Design</h2>
            <p>Great design makes you memorable. We deliver artwork that underscores your brand message and captures potential clients attention.</p>
          </div>
        </div>
        <div className='top-grid-item' id='mandarine'>
          <div>
            <h2>Photography</h2>
            <p>Increase your credibility by getting the most stunning, high-quality photos that improve your buisness image.</p>  
          </div>
        </div>
      </div>
      ...
      <div className='testimonials-container'>
        ...
        <div className='testimonials'>
          <div className='testimonial'>
            <img src={emily}></img>
            <p className='review'>We put our trust in Sunnyside and they delivered, making sure our needs were met and deadlines were always hit.</p>
            <div>
          ...
          <div className='testimonial'>
            <img src={thomas}></img>
            <p className='review'>Sunnyside's enthusiasm coupled with their keen interest in our brand's success made it a satisfying and enjoyable experience.</p>
            <div>
          ...
          <div className='testimonial'>
            <img src={jennie}></img>
            <p className='review'>Incredible end result! Our sales increased over 400% when we worked with Sunnyside. Highly recommended!</p>
            <div>
              <p className='name'>Jennie F.</p>
              <p className='position'>Buisness Owner</p>
            </div>
          </div>
        </div>
      ...
      <div className='bottom-grid-container'>
        <div className='bottom-grid-item' id='bottles'></div>
        <div className='bottom-grid-item' id='plates'></div>
        <div className='bottom-grid-item' id='cone'></div>
        <div className='bottom-grid-item' id='sugar'></div>
      </div>
      ...
      <div className='footer'>
        ...
        <div className='footer-socials'>
          <svg className='social-icon' width="20" height="20" xmlns="http://www.w3.org/2000/svg"><path d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.506 0 18.896 0z" fill="#2C7566" fill-rule="nonzero"/></svg>
